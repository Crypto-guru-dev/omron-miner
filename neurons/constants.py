...
# Optimized timeout constants for better performance
VALIDATOR_REQUEST_TIMEOUT_SECONDS = 120
CIRCUIT_TIMEOUT_SECONDS = 45  # Reduced from 60 for faster response
...
EXTERNAL_REQUEST_QUEUE_TIME_SECONDS = 5  # Reduced from 10
